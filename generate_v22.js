...
// V21のベースをテンプレートリテラルで用意しつつ、感情プロパティ(emotionEffect)を追加してV22を書き出す
const outputContent = `/**
...
try {
  fs.writeFileSync('src/constants/knowledge-base-v22.ts', outputContent);
  console.log("Successfully generated v22");
} catch (e) {
