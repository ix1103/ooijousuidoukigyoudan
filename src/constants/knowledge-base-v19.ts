/**
 * アイ君のための知識ベース（V19：超絶精度・感情適応・メタIntent推論対応）
 */

// シノニム辞書（V19：方言・誤字・感情キーワードの拡充）
...
export const AI_KUN_KNOWLEDGE_V19: KnowledgeItem[] = [
  // ── 組織・企業情報 ────────────────────────
  {
...
// ▼ V19: 会話のバリエーション超超拡充（約100パターン・感情対応）
