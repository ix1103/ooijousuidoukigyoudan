...
export default function WaterOutagePage() {
    ...
    return (
        <div className="min-h-screen pt-20">
            <PageHeader
                title="断水情報"
                subtitle={<>突発断水・計画断水の状況をお知らせします。<br />緊急の場合は <strong className="text-secondary-vibrant"><Phone size={18} className="inline-block mr-1 -mt-0.5" />0547-46-4130</strong> へご連絡ください。</>}
